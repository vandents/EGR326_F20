...
void ST7735_OutUDec(uint32_t n, uint16_t cs_pin);
...
// Output: none
void ST7735_SetRotation(uint8_t m, uint16_t cs_pin);
...
// Output: none
void ST7735_InvertDisplay(int i, uint16_t cs_pin);
...
// Outputs: none
void ST7735_PlotClear(int32_t ymin, int32_t ymax, uint16_t cs_pin);
...
// Outputs: none
void ST7735_PlotPoint(int32_t y, uint16_t cs_pin);
...
// Inputs: y is the y coordinate of the point plotted
// Outputs: none
void ST7735_PlotLine(int32_t y, uint16_t cs_pin);
...
// Outputs: none
void ST7735_PlotPoints(int32_t y1, int32_t y2, uint16_t cs_pin);
...
// Outputs: none
void ST7735_PlotBar(int32_t y, uint16_t cs_pin);
...
// Outputs: none
void ST7735_PlotdBfs(int32_t y, uint16_t cs_pin);
...
// Inputs: none
// Outputs: none
void ST7735_PlotNextErase(uint16_t cs_pin);
...
// Outputs: none
void ST7735_OutChar(char ch, uint16_t cs_pin);
...
// outputs: none
void ST7735_OutString(char *ptr, uint16_t cs_pin);
...
// Inputs: none
// Outputs: none
void Output_Init(uint16_t color);

// Clear display
void Output_Clear(uint16_t color);

// Turn off display (low power)
void Output_Off(uint16_t color);

// Turn on display
void Output_On(uint16_t color);
